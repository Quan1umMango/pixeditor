...
const PAINT_BRUSH_ICON:egui::widgets::ImageSource = egui::include_image!("../assets/icons/paintbrush.png");
        ...
        match self.state {
            AppState::MainMenu => {
                ...
                let open_old = widgets::Button::new("Open New")
                    .size(btn_size)
                    .position(vec2(window_size.x/2.0 - btn_size.x/2.0, window_size.y/2.0 + btn_size.x/4.0 - padding));
                ...
                egui_macroquad::ui(|egui_ctx| {
                    egui::Window::new("Create New Project")
                        ...
                        .show(egui_ctx, |ui| {
                            ...
                            let num_pixels_input = egui::TextEdit::singleline(&mut st.num_pixels_string);
                            ...
                            if ui.button("Done!").clicked() {
                                if let Ok(v) = st.num_pixels_string.parse::<usize>() {
                                    new_state = Some(AppState::Drawing(Project::new(st.file_name.clone(),v)));
                                } else {
                                   return  
                                }
                            }
